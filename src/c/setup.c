...
static void setup_time_layer(Layer *window_layer, GRect bounds)
{
    ...
    text_layer_set_background_color(time_layer, PBL_IF_COLOR_ELSE(GColorRed, GColorBlack));
    text_layer_set_text_color(time_layer, PBL_IF_COLOR_ELSE(GColorRed, GColorClear));
...
static void setup_steps_layer(Layer *window_layer, GRect bounds)
{
    ...
    text_layer_set_background_color(steps_layer, PBL_IF_COLOR_ELSE(GColorRed, GColorBlack));
    text_layer_set_text_color(steps_layer, PBL_IF_COLOR_ELSE(GColorRed, GColorClear));
...
static void setup_date_layer(Layer *window_layer, GRect bounds)
{
    ...
    text_layer_set_background_color(date_layer, PBL_IF_COLOR_ELSE(GColorRed, GColorBlack));
    text_layer_set_text_color(date_layer, PBL_IF_COLOR_ELSE(GColorRed, GColorClear));
...
static void setup_week_day_layer(Layer *window_layer, GRect bounds)
{
    ...
    text_layer_set_background_color(week_day_layer, PBL_IF_COLOR_ELSE(GColorRed, GColorBlack));
    text_layer_set_text_color(week_day_layer, PBL_IF_COLOR_ELSE(GColorRed, GColorClear));
...
static void setup_week_number_layer(Layer *window_layer, GRect bounds)
{
    ...
    text_layer_set_background_color(week_numer_layer, PBL_IF_COLOR_ELSE(GColorRed, GColorBlack));
    text_layer_set_text_color(week_numer_layer, PBL_IF_COLOR_ELSE(GColorRed, GColorClear));
